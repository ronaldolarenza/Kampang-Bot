...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"         **♛ ᴀᴢɴᴇʀᴀʟ ʙᴏᴛ ♛** \n\n"
        f"   **╰✠╼━━━━━━❖━━━━━━━✠╯**\n"
        f"•➣ ♛ **ᴀᴢɴᴇʀᴀʟ ʙᴏᴛ** :    `{DEFAULTUSER}` \n"
        f"•➣ 👤 **ᴜꜱᴇʀɴᴀᴍᴇ** :   @{user.username} \n"
        f"•➣ 💻 **ᴛᴇʟᴇɴᴛʜᴏɴ** :     `Versi {version.__version__}` \n"
        f"•➣ 🐍 **ᴘʏᴛʜᴏɴ**    :        `Versi {python_version()}` \n"
        f"•➣ 🌐 **ʙᴏᴛ ᴠᴇʀꜱɪᴏɴ**:    `{BOT_VER}` \n"
        f"•➣ 🗃️ **ᴍᴏᴅᴜʟᴇ**       :       `{len(modules)}` \n\n"
        f"**┏▼━━━━━━━━━━━━━━━━━▼┓**\n"
        f"    🌐 **ɪɴꜱᴛᴀɢʀᴀᴍ.   :** [ɪɴꜱᴛᴀɢʀᴀᴍ](https://instagram.com/ronaldolarenza112)\n"
        f"   📝 **ᴄʜᴀɴɴᴇʟ.: ** [ꜱᴜᴘᴘᴏʀᴛ](https://t.me/kataazneral)\n"
        f"    💋 **ꜱᴜᴘᴘᴏʀᴛ ʙʏ.   :** [ʀᴏɴᴀʟᴅᴏ ʟᴀʀᴇɴᴢᴀ](https://t.me/hirascal)\n"
        f"┗▲━━━━━━━━━━━━━━━━━▲┛")
